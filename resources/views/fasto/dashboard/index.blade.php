...
<div class="container-fluid">
				...
				<div class="card-body box-style">
					<div class="media align-items-center">
						<div class="media-body me-3">
							<h2 class="num-text text-black font-w700">{{$organisations}}</h2>
							<span class="fs-14">Total organisation Handled</span>
						</div>
		...
		<div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
			...
			<div class="bg-warning card-border"></div>
				<div class="card-body box-style">
					<div class="media align-items-center">
						<div class="media-body me-3">
							<h2 class="num-text text-black font-w700">{{$contacts}}</h2>
		...
		<div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
			...
			<div class="bg-primary card-border"></div>
				<div class="card-body box-style">
					<div class="media align-items-center">
						<div class="media-body me-3">
							<h2 class="num-text text-black font-w700">{{$leads}}</h2>
		...
		<div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
			<div class="card card-bd">
				...
				<div class="card-body box-style">
					<div class="media align-items-center">
						<div class="media-body me-3">
							<h2 class="num-text text-black font-w700">{{$deals}}</h2>
							<span class="fs-14">Total Deals</span>
						</div>
	...
	<div class="row">
		...
		<div class="col-xl-3 col-xxl-6 col-sm-6">
			<div class="card">	
				<div class="card-header border-0 pb-0">
					<h4 class="fs-20 mb-0 text-black">Your deals percentage</h4>
					<div class="dropdown">
						{{-- <a href="javascript:void(0)" data-bs-toggle="dropdown" aria-expanded="false">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="#575757" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
				...
				<div class="card-body text-center pt-0">
					...
					<span class="fs-14 text-black d-block op5">{{auth()->user()->package->deal_limit}} Deals </span>
				</div>
			</div>
		</div>
		<div class="col-xl-3 col-xxl-6 col-sm-6">
			<div class="card">	
				<div class="card-header border-0 pb-0">
					<h4 class="fs-20 mb-0 text-black">Your Leads percentage</h4>
					<div class="dropdown">
						{{-- <a href="javascript:void(0)" data-bs-toggle="dropdown" aria-expanded="false">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="#575757" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
				...
				<div class="card-body text-center pt-0">
					<div id="radialChartLead" class="monthly-project-chart"></div>
					<span class="fs-14 text-black d-block op5">{{auth()->user()->lead_limit}} Leads </span>
				</div>
			</div>
		</div>
		<div class="col-xl-3 col-xxl-6 col-sm-6">
			<div class="card">	
				<div class="card-header border-0 pb-0">
					<h4 class="fs-20 mb-0 text-black">Your organisation percentage</h4>
					<div class="dropdown">
						{{-- <a href="javascript:void(0)" data-bs-toggle="dropdown" aria-expanded="false">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="#575757" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
				...
				<div class="card-body text-center pt-0">
					<div id="radialChartOrg" class="monthly-project-chart"></div>
					<span class="fs-14 text-black d-block op5">{{auth()->user()->organization_limit}} Organization </span>
				</div>
			</div>
		</div>
	</div>	
...
@push('scripts')
	<script>
		...
		var options = {
          series: [{
            name: "Desktops",
            data: {{ json_encode($countsClientsArray) }}
        }],
          chart: {
          height: 270,
          type: 'line',
	...
	<script>
		 ...
		 var options = {
          series: [{{(100 / auth()->user()->deal_limit) * $deals}}],
          chart: {
          height: 230,
          type: 'radialBar',
          toolbar: {
	...
	<script>
			var radialLeadChart = function(){
		 var options = {
          series: [{{(100 / auth()->user()->lead_limit) * $leads}}],
          chart: {
          height: 230,
          type: 'radialBar',
          toolbar: {
        ...
        var chart = new ApexCharts(document.querySelector("#radialChartLead"), options);
        chart.render();
	}
	</script>
	<script>
			var radialChartOrg = function(){
		 var options = {
          series: [{{(100 / auth()->user()->organization_limit) * $organisations}}],
          chart: {
          height: 230,
          type: 'radialBar',
          toolbar: {
        ...
        var chart = new ApexCharts(document.querySelector("#radialChartOrg"), options);
        chart.render();
	}
	</script>
@endpush